using Notify.Application.Orders.CustomerOrder.Queries;
using MediatR;
...
public class OrderController(ISender sender) : ControllerBase
{
    ...
    public async Task<IActionResult> GetCustomerOrderDetails([FromRoute] Guid customerId, [FromRoute] Guid orderId)
    {
        var orderDetails = await _sender.Send(new GetOrderQuery(orderId, customerId));
